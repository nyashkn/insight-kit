// GENERATED by deploy/scripts/gen-pi-schema.ts — DO NOT EDIT BY HAND.
// Single schema source (C5): the insight_kit.platform.gate.schema pydantic models.
// Regenerate after any schema change: bun run pi:gen-schema
